META = {
    ...
    'description': 'アガベや塊根植物の即売会(イベント)は値段も種類も豊富ですが、初参加で何を見るべきか迷いがち。事前準備、現地での見極め方、出店者との会話、価格交渉のマナーなど、実体験ベースで整理しました。',
    'keywords': '植物即売会,イベント,アガベ,塊根,コーデックス,初参加,買付け',
    'category': 'イベント',
    'read_min': 8,
    'lead': '植物即売会は園芸店では見られないレアな品種が並び、出店者と直接話せる貴重な場です。一方で、初参加では「何から見ればいいかわからない」「いくらが妥当か判断できない」といった戸惑いも多いはず。出店者・参加者の両側で経験してきた立場から、当日の動き方をまとめました。',
}
RELATED = [
