...
# Find the eventsGrid div and replace its content
# Pattern: <div class="events-grid" id="eventsGrid"> ... closing </div> before load-more-wrap
pattern = r'(<div class="events-grid" id="eventsGrid">)(.*?)(<div class="load-more-wrap">)'
...
print(f"Updated index.html with {event_count} event cards")
print("Done!")
